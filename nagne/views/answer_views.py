    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect('{}#answer_{}'.format(
                resolve_url('nagne:detail', assignment_id=assignment.id), answer.id))
    else:
        form = AnswerForm()
...
def answer_modify(request, answer_id):
    ...
    if request.user != answer.author:
        ...
        return redirect('nagne:detail', assignment_id=answer.assignment.id)
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            answer.save()
            return redirect('{}#answer_{}'.format(
                resolve_url('nagne:detail', assignment_id=answer.assignment.id), answer.id))
    else:
